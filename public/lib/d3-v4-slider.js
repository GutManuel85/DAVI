// Source: https://github.com/bobhaslett/d3-v4-sliders/blob/master/slider.js
// adapted by Manuel Gut and Remo Grab
...
function sliderFactory(d) {
    ...
    function drawSlider(p) {
            ...
            if (scale) {
                ...
                let axis=track.append("g")
                    ...
                    .call(d3[axisType](sliderScale)
                        ...
                        // line below added to show years on axis without separator
        ...
        function transHandle(orient) {
            const event = new Event('sliderEvent');
            dispatchEvent(event);
            return{
